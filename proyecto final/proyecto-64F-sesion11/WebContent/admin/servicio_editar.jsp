	...
	<div id="wrapper">
		<div id="content" style="height: 210px;">
             ...
             ServicioBean servicio = 
             				(ServicioBean)request.getAttribute("servicio");
             %>
             <h3>Editar servicio</h3>
             <form action="<%=request.getContextPath() %>/Servicio" method="post">
             <input type="hidden" value="editar" name="funcion" />
             <input type="hidden" value="<%=servicio.getId() %>" name="txt_id" />  
             Nombre: <input value="<%=servicio.getNombre() %>" type="text" name="txt_nombre" />
             <br /><br />
